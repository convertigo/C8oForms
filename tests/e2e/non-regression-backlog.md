...
Resume: 232 tickets dans le milestone `2.2.0`; 224 tickets candidats; 50 deja couverts; 174 a couvrir (24 ouverts, 150 fermes); 8 exclus par label, absence de label candidat, ou exclusion explicite.
...
| [ ] | [#1430](https://github.com/convertigo/C8oForms/issues/1430) | closed | bug, QC-Passed | Baserow source fails when sorting by a hidden field |  |
| [ ] | [#1429](https://github.com/convertigo/C8oForms/issues/1429) | closed | bug, QC-Passed | Import File component opens an oversized modal with incorrect .c8oforms project import wording |  |
